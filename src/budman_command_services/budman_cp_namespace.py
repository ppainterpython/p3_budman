...
CV_CLOSE_CMD_NAME = "close"
CV_CLOSE_CMD_KEY = CV_CLOSE_CMD_NAME + p3m.CK_CMD_KEY_SUFFIX
...
CV_CLOSE_WORKBOOKS_SUBCMD_KEY = CV_CLOSE_CMD_KEY + "_" + CV_WORKBOOKS_SUBCMD_NAME
...
CV_FOLDER_SUBCMD_NAME = "folder"
CV_LIST_FOLDER_SUBCMD_KEY = CV_LIST_CMD_KEY + "_" + CV_FOLDER_SUBCMD_NAME
CV_SHOW_DATA_CONTEXT_SUBCMD_KEY = CV_SHOW_CMD_KEY + "_" + CV_DATA_CONTEXT_SUBCMD_NAME
...
CV_UPDATE_SUBCMD_NAME = "update"
CV_WORKFLOW_UPDATE_SUBCMD_KEY = CV_WORKFLOW_CMD_KEY + "_" + CV_UPDATE_SUBCMD_NAME
...
CV_GUI_SUBCMD_NAME = "gui"
CV_GUI_SUBCMD_KEY = CV_APP_CMD_KEY + "_" + CV_GUI_SUBCMD_NAME
CV_EXIT_SUBCMD_NAME = "exit"
CV_EXIT_SUBCMD_KEY = CV_APP_CMD_KEY + "_" + CV_EXIT_SUBCMD_NAME
CV_APP_REFRESH_SUBCMD_NAME = "refresh"
CV_APP_REFRESH_SUBCMD_KEY = CV_APP_CMD_KEY + "_" + CV_APP_REFRESH_SUBCMD_NAME
CV_FILE_DELETE_SUBCMD_NAME = "delete"
CV_FILE_DELETE_SUBCMD_KEY = CV_APP_CMD_KEY + "_" + CV_FILE_DELETE_SUBCMD_NAME
CV_WORKFLOW_DELETE_SUBCMD_KEY = CV_WORKFLOW_CMD_KEY + "_" + CV_FILE_DELETE_SUBCMD_NAME
...
CK_WF_FOLDER_TRIPLET = CK_WF_FOLDER + "_triplet"
