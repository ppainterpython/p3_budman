...
class BudgetModelTemplate(BudgetModel):
    ...
    def __init__(self, create_missing_folders : bool = True,
        ...
        try:
            ...
            self.bm_bf = BM_DEFAULT_BUDGET_FOLDER   # property
