...
#region Housing, Utilities etc.
    ...
    r'(?i)\bReliant\sEnergy\b': 'Housing-GrapeCove.Utilities.Electric',
    r'(?i)\bONE\sGAS\b': 'Housing-GrapeCove.Utilities.Natural Gas',
    r'(?i)\bATMOS\sENERGY\b': 'Housing-GrapeCove.Utilities.Natural Gas',
    r'(?i)\bService\sExperts\b': 'Housing-GrapeCove.Maintenance.HVAC',
    r'(?i)\bBrushy\sCreek\sMUD\b': 'Housing-GrapeCove.Utilities.MUD',
    r'(?i)\bAT\&T\sU-Verse\b': 'Housing-GrapeCove.Telecom.ATT U-Verse',
    r'(?i)\bCULLIGAN\b': 'Housing-GrapeCove.Culligan',
    r'(?i)\bCULLINGAN\b': 'Housing-GrapeCove.Culligan',
    # Castle Pines
    ...
    r'(?i)\bPedernales_Elec\b': 'Housing.Utilities.Electric',
    r'(?i)\bGoogle\sFIBER\b': 'Housing.Telecom.Google Fiber',
    r'(?i)\bGoogle\s*\*FIBER\b': 'Housing.Telecom.Google Fiber',
    r'(?i)\bCity\sof\sAustin\b': 'Housing.Utilities.City of Austin',
    r'(?i)\bGOOGLE\s\*FIBER\b': 'Housing.Internet.Google Fiber',
    ...
    r'(?i)\bRING\sBASIC\sPLAN\b': 'Housing.Ring Security Service',
    r'(?i)\bSTRAND\sBROTHERS\sSERVICE\b': 'Housing.Maintenance.HVAC',
