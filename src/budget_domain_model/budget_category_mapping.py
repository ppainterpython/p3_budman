...
category_map = {
    ...
    r'(?i)\bID:23ANDME\sINC\b': 'Health and Wellbeing.23andMe',
    ...
    r'(?i)\bSUNDANCE\s*NOW.*': 'Subscription.Sundance Now',
    r'(?i)\bKindle\b.*Svcs.*': 'Subscription.Kindle',
    r'(?i)\bGOOGLE.*YouTubePremium.*': 'Subscription.YouTube Premium',
    r'(?i)\bDisney.*Plus.*': 'Subscription.Disney Plus',
    r'(?i)\bDREAMSTIME\.COM.*': 'Subscription.Dreamstime',
    r'(?i)\bSPOTIFY\b': 'Subscription.Spotify',
    r'(?i).*DIRECTV?.*STREAM\b': 'Subscription.DirectTV Stream',
    r'(?i)\bLEGALNATURE\b': 'Subscription.Legal Nature',
    # Entertainment
