...
BUDMAN_VALID_WF_PURPOSE_KEY_VALUES = "workflows.valid_wf_purpose_key_values"  # List of valid workflow purpose keys
BUDMAN_DEFAULT_WF_PURPOSE_KEY = "workflows.default_wf_purpose_key"
