...
__all__ = [
    ...
    "BUDMAN_CMD_STARTUP_SCRIPT",
    "BUDMAN_VALID_WF_PURPOSE_KEY_VALUES",
    "BUDMAN_DEFAULT_WF_PURPOSE_KEY",
    "WORKFLOWS",
    "BUDMAN_VALID_WF_KEY_VALUES",
    "BUDMAN_DEFAULT_WF_KEY",
    "FINANCIAL_INSTITUTIONS",
    "BUDMAN_VALID_FI_KEY_VALUES",
    "BUDMAN_DEFAULT_FI",
    "CATEGORY_CATALOG",
