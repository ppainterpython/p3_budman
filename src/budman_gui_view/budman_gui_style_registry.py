...
class StyleRegistry:
    ...
    def _define_styles(self):
        ...
        self.style.configure('BMG.TFrame', background=BMG_FAINT_GRAY)
        self.style.configure('BMG.TLabel', background=BMG_FAINT_GRAY, font=font_style)
        self.style.configure('BMG.TEntry', font=font_style)
        self.style.configure('BMG.TButton', font=font_style)
