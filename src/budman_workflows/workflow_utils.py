...
#     """Return a tree structure of the BDM_STORE in the provided DataContext."""
#     try:
...
#             for wf_key, wf_folder_config_list in fi_obj[bdm.FI_WF_FOLDER_CONFIG_COLLECTION].items():
#                 for wf_folder_config in wf_folder_config_list:
#                     wf_folder_id = wf_folder_config[bdm.WF_FOLDER_ID]
#                     if wf_folder_id == bdm.WF_INPUT_FOLDER:
#                         tag = f"'{wf_folder_config[bdm.WF_INPUT_FOLDER]}' (wf_input)"
#                     elif wf_folder_id == bdm.WF_WORKING_FOLDER:
#                         tag = f"'{wf_folder_config[bdm.WF_WORKING_FOLDER]}' (wf_working)"
#                     elif wf_folder_id == bdm.WF_OUTPUT_FOLDER:
#                         tag = f"'{wf_folder_config[bdm.WF_OUTPUT_FOLDER]}' (wf_output)"
#                     else:
#                         tag = f"'{wf_folder_id}' (unknown folder)"
#                     tree.create_node(tag, f"{fi_key}_{wf_key}_{wf_folder_id}", parent=f"{fi_key}")
